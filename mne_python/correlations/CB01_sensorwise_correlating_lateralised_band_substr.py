...
lat_sheet_fname_nooutlier = op.join(substr_dir, 'lateralization_volumes_nooutliers.csv')  # vol outliers removed who are below 10th percentile
...
bands = {
    'Delta': (1, 4),
    'Theta': (4, 8),
    'Alpha': (8, 14),  # different than CG02 script
    'Beta': (14, 40)
}
